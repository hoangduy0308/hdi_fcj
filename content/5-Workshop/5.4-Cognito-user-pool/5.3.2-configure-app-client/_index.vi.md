...
{{< siteimg src="/images/5-Workshop/5.4-Cognito-user-pool/05-cognito-mobile-client-details.png" alt="Chi tiết App Client trustbite-mobile không có client secret" style="width: 100%; max-width: 1200px; display: block; margin: 1.5rem auto; border-radius: 6px; box-shadow: 0 4px 20px rgba(0,0,0,0.08);" >}}
...
{{< siteimg src="/images/5-Workshop/5.4-Cognito-user-pool/06-cognito-domain.png" alt="Cognito domain dành cho Managed Login trong Region Singapore" style="width: 100%; max-width: 1200px; display: block; margin: 1.5rem auto; border-radius: 6px; box-shadow: 0 4px 20px rgba(0,0,0,0.08);" >}}
