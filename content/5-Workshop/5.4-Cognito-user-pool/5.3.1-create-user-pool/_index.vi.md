...
{{< siteimg src="/images/5-Workshop/5.4-Cognito-user-pool/03-cognito-sign-in.png" alt="Cấu hình đăng nhập bằng email và mật khẩu của Cognito User Pool" style="width: 100%; max-width: 1200px; display: block; margin: 1.5rem auto; border-radius: 6px; box-shadow: 0 4px 20px rgba(0,0,0,0.08);" >}}
...
{{< siteimg src="/images/5-Workshop/5.4-Cognito-user-pool/04-cognito-sign-up.png" alt="Cấu hình tự đăng ký và xác minh địa chỉ email trong Cognito" style="width: 100%; max-width: 1200px; display: block; margin: 1.5rem auto; border-radius: 6px; box-shadow: 0 4px 20px rgba(0,0,0,0.08);" >}}
...
{{< siteimg src="/images/5-Workshop/5.4-Cognito-user-pool/01-cognito-user-pool-overview.png" alt="Trang tổng quan Cognito User Pool trong Region Asia Pacific Singapore" style="width: 100%; max-width: 1200px; display: block; margin: 1.5rem auto; border-radius: 6px; box-shadow: 0 4px 20px rgba(0,0,0,0.08);" >}}
...
{{< siteimg src="/images/5-Workshop/5.4-Cognito-user-pool/02-cognito-app-clients.png" alt="Danh sách App Client trustbite-mobile và trustbite-admin-web trong Cognito" style="width: 100%; max-width: 1200px; display: block; margin: 1.5rem auto; border-radius: 6px; box-shadow: 0 4px 20px rgba(0,0,0,0.08);" >}}
