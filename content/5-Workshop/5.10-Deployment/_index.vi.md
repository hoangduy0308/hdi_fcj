...
{{< siteimg src="/images/5-Workshop/5.10-Deployment/13-s3-bucket-private.png" alt="Cấu hình Block Public Access đang bật cho bucket hóa đơn TrustBite trên Amazon S3" style="width: 100%; max-width: 1200px; height: auto;" >}}
...
{{< siteimg src="/images/5-Workshop/5.10-Deployment/14-ecr-api-images.png" alt="Các Docker image gắn tag commit SHA trong repository trustbite-dev-api trên Amazon ECR" style="width: 100%; max-width: 1200px; height: auto;" >}}
...
{{< siteimg src="/images/5-Workshop/5.10-Deployment/15-ecs-services-running.png" alt="Ba dịch vụ TrustBite dev trên Amazon ECS đều Active và chạy đủ một trên một Fargate task" style="width: 100%; max-width: 1200px; height: auto;" >}}
