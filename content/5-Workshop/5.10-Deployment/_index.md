...
{{< siteimg src="/images/5-Workshop/5.10-Deployment/13-s3-bucket-private.png" alt="Amazon S3 Block Public Access enabled for the TrustBite development receipt bucket" style="width: 100%; max-width: 1200px; height: auto;" >}}
...
{{< siteimg src="/images/5-Workshop/5.10-Deployment/14-ecr-api-images.png" alt="Commit SHA tagged Docker images in the trustbite-dev-api Amazon ECR repository" style="width: 100%; max-width: 1200px; height: auto;" >}}
...
{{< siteimg src="/images/5-Workshop/5.10-Deployment/15-ecs-services-running.png" alt="Three TrustBite development services active on Amazon ECS with one of one Fargate task running" style="width: 100%; max-width: 1200px; height: auto;" >}}
