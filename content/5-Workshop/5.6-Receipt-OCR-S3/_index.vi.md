...
{{< siteimg src="/images/5-Workshop/5.6-Receipt-OCR-S3/17-s3-textract-unit-tests.png" alt="Kết quả unit test S3 Object Storage và AWS Textract của TrustBite đều vượt qua" style="width: 100%; max-width: 1200px; height: auto;" >}}
